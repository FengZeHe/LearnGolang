...
import (
	...
	domain "github.com/basicprojectv2/internal/domain"
...
func (m *MockUserService) FindOrCreate(ctx context.Context, phone, id string) (domain.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOrCreate", ctx, phone, id)
	ret0, _ := ret[0].(domain.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserServiceMockRecorder) FindOrCreate(ctx, phone, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindOrCreate", reflect.TypeOf((*MockUserService)(nil).FindOrCreate), ctx, phone, id)
}
