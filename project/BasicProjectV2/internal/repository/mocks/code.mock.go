...
func (m *MockCodeRepository) SetCode(ctx context.Context, biz, phone, code string) error {
	m.ctrl.T.Helper()
...
func (mr *MockCodeRepositoryMockRecorder) SetCode(ctx, biz, phone, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetCode", reflect.TypeOf((*MockCodeRepository)(nil).SetCode), ctx, biz, phone, code)
}

// VerifyCode mocks base method.
func (m *MockCodeRepository) VerifyCode(ctx context.Context, biz, phone, code string) (bool, error) {
	m.ctrl.T.Helper()
